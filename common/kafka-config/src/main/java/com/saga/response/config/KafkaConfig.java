package com.saga.response.config;

import com.saga.response.dto.KafkaConfigProperties;
...
public interface KafkaConfig {
    ...
    @Bean
    default ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory(ConsumerFactory<String, String> consumerFactory) {
